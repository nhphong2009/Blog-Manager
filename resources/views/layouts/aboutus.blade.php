...
@section('title_aboutus')
	<title>Blog - Zent | About Us</title>
@endsection
@section('aboutus')
	<!-- CONTENT -->
    	<div class="content col-xs-8">
        	...
        	<article>
            	<div class="post-image">
                	<img src="{{"blog_assets/img/img-post-6.jpg"}}" alt="post image 1"> 
                </div>
                <div class="post-text">
                    <h2>About US</h2>
                </div>                 
                <div class="post-text text-content">                  
                    ...
                    <div class="gallery">
                    	<div class="item-gallery-left">
                        	<img src="{{ "blog_assets/img/img-post-gallery-1.jpg" }}">
                            <img src="{{ "blog_assets/img/img-post-gallery-2.jpg" }}">
                        </div>
                        <div class="item-gallery-center">
                        	<img src="{{ "blog_assets/img/img-post-gallery-big.jpg" }}">
                        </div>	
                        <div class="item-gallery-right">    
                            <img src="{{ "blog_assets/img/img-post-gallery-3.jpg" }}">
                            <img src="{{ "blog_assets/img/img-post-gallery-4.jpg" }}">
                    	</div>	
